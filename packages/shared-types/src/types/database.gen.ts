  ...
  public: {
    Tables: {
      addon: {
        ...
        Relationships: [
          {
            foreignKeyName: "addon_category_type_id_fkey"
            columns: ["category_type_id"]
            isOneToOne: false
            referencedRelation: "addon_category"
      ...
      addon_category: {
        ...
        Relationships: [
          {
            foreignKeyName: "addon_category_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
      ...
      product: {
        ...
        Relationships: [
          {
            foreignKeyName: "product_category_type_id_fkey"
            columns: ["category_type_id"]
            isOneToOne: false
      ...
      product_price: {
        ...
        Relationships: [
          {
            foreignKeyName: "product_price_code_id_fkey"
            columns: ["code_id"]
            isOneToOne: false
